...
int main() {
    ...
    //std::string nazwa_pliku = "../test2.txt";
    //std::string nazwa_pliku = "../100_Independent1400";
    // std::string nazwa_pliku = "../100_Independent0290";
    // std::string nazwa_pliku = "../100_Independent0297";
    // std::string nazwa_pliku = "../100_Independent0360";
    std::string nazwa_pliku = "../100_Independent0376";
    // std::string nazwa_pliku = "../100_Independent0428";
    // std::string nazwa_pliku = "../instancja_12.txt";
